...
# ['''Two_orbital_Singlet_43_43_0_0.05_0.075_1.00_1_0.35_1.21''',r'Multiorbital singlet, $\rho_+$'],
...
def Data(i):
    ...
    ft=PeakPhaseResolved(sign, dos, omegas, omega, dOmega)
...
fig=Main()
plt.show()
# fig.savefig('out/'+f'Peak_phase_resolved_QPI_mosaic_{np.real(omega):.2f}_'+folder+'.pdf', bbox_inches = "tight")