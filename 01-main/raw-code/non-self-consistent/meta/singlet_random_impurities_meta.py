...
i=0
def create_name(n_x,n_y,mu,s,delta,t,Delta,V,trial):
        return f'Random_impurities_singlet_{trial:d}_{n_x:d}_{n_y:d}_{mu:0.2f}_{s:0.2e}_{delta:0.2e}_{t:0.2f}_{Delta:0.2e}_{V:0.2e}'.replace('0.00e+00','0')
for trial in range(n_trials):
    n_y=n_x
    confname = os.path.join(fileDir, 'output/'+create_name(n_x,n_y,mu,s,delta,t,Delta,V,trial))
