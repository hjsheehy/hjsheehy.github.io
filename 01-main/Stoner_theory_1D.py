...
def plot_phase_diagram_Us(phase_diagram_Us,FIGNAME):
    fig, axs = plt.subplots(3,1,sharex=True)
    axs[0] = phase_diagram_Us.plot_phase_diagram(axs[0],field_index=1,minus_field_index=2,absolute=True)
    axs[1] = phase_diagram_Us.plot_phase_diagram(axs[1],field_index=1,plus_field_index=2)
    # axs[2] = phase_diagram_Us.plot_phase_diagram(axs[2],field_index=3,absolute=True)
    # axs[3] = phase_diagram_Us.plot_phase_diagram(axs[3],field_index=4,absolute=True)
    axs[-1] = phase_diagram_Us.plot_phase_diagram(axs[-1],field_index=0)
...
def plot_phase_diagram_Delta(phase_diagram_Delta,FIGNAME):
    ...
    # axs[0] = phase_diagram_Delta.plot_phase_diagram(axs[0],field_index=1,minus_field_index=2,absolute=True)
    axs[0] = phase_diagram_Delta.plot_phase_diagram(axs[0],field_index=1,plus_field_index=2)
    axs[1] = phase_diagram_Delta.plot_phase_diagram(axs[1],field_index=3,absolute=True)
    axs[2] = phase_diagram_Delta.plot_phase_diagram(axs[2],field_index=4,absolute=True)
    axs[-1] = phase_diagram_Delta.plot_phase_diagram(axs[-1],field_index=0)

    # axs[0].set_ylabel(r'$|\langle\hat{M}\rangle|$')
    axs[0].set_ylabel(r'$\sum_\sigma\phi_\sigma$')
    axs[1].set_ylabel(r'$|\Phi_{\uparrow\downarrow}|$')
    axs[2].set_ylabel(r'$|\Delta_{\uparrow\downarrow}|$')
    axs[-1].set_ylabel('Free energy')
    axs[-1].set_xlabel(r'$\mu$')
...
def plot_phase_diagram(phase_diagram_Us,phase_diagram_Delta,FIGNAME):
    fig, axs = plt.subplots(5,2,sharex=True,sharey='row')
    axs[0,0] = phase_diagram_Us.plot_phase_diagram(axs[0,0],field_index=1,minus_field_index=2,absolute=True)
    axs[1,0] = phase_diagram_Us.plot_phase_diagram(axs[1,0],field_index=1,plus_field_index=2)
    axs[2,0] = phase_diagram_Us.plot_phase_diagram(axs[2,0],field_index=3,absolute=True)
    axs[3,0] = phase_diagram_Us.plot_phase_diagram(axs[3,0],field_index=4,absolute=True)
    ...
    axs[0,1] = phase_diagram_Delta.plot_phase_diagram(axs[0,1],field_index=1,minus_field_index=2,absolute=True)
    axs[1,1] = phase_diagram_Delta.plot_phase_diagram(axs[1,1],field_index=1,plus_field_index=2)
    axs[2,1] = phase_diagram_Delta.plot_phase_diagram(axs[2,1],field_index=3,absolute=True)
    ...
    axs[0,1].set_title(r'Initial $\Delta_{\uparrow\downarrow},\Phi_{\uparrow\downarrow}\not=0$')
