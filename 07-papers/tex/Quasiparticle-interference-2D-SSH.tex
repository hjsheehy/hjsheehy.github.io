...
\createfigure{2D-Weyl-SSH_impurity_wall/majorana_fermi_arc}{majorana_fermi_arc}

The $x$-axis is glued to periodic boundary conditions.
\createfigure{2D-Weyl-SSH_impurity_wall_PBC/majorana_fermi_arc}{majorana_fermi_arc}
