\title{Quasiparticle-interference results for a two-dimensional superconducting multiorbital Weyl SSH model}
\author{Henry Sheehy}
\date{ \today }
...
\begin{itemize}
    \item Phase diagram of self-consistent calculation of bulk Weyl-SSH model.
    \item Think of a way to pair two (spinless) Weyl-SSH models, via some spin-coupling, such that a regime in which one spin-chain is superconducting and the other is normal can be engineered.
    \item Publish code.
    \item Present QPI results at {\it ExoSup}.
\end{itemize}

\section{Finance}
\begin{itemize}
    \item Applying to teach at Brighton College?
    \item Possibility of beginning funding applications?
\end{itemize}
