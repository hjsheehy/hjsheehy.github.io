...
MU=[-2.12]
R=np.arange(0.012,4.423,0.2002)
T=np.arange(0.008,4.312,0.1982)
# R=np.arange(0.012,4.423,1.002)
# T=np.arange(0.008,4.312,0.982)
VV=[0,1.47]
states=['INT','unitary']
trajectories=['forward','reverse','up','down']
